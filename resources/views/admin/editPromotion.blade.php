    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10 col-md-offset-1 text-center">
                <h1 class="hestia-title ">Edit Promotion</h1>
            </div>
        </div>
    </div>
                            ...
                            <form method="post" action="{{url('admin/update-promotion/'.$promotion->id)}}">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="business" id="business" class="form-control">
                                            ...
                                            <option value="{{$business->id}}" {{ $business->id == $promotion->business_id ? "selected" : ""}}>{{$business->name}}</option>
                                            @endforeach
                                            @endif
                                        </select>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" aria-describedby="nameHelp" placeholder="Enter Title Name" name="title" value="{{$promotion->title}}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="type" id="type" class="form-control">
                                            <option value="">Choose...</option>
                                            <option value="1" {{ $promotion->discount_type == "1" ? "selected" : "" }}>Flat</option>
                                            <option value="2" {{ $promotion->discount_type == "2" ? "selected" : "" }}>Percentage</option>
                                        </select>
                                        @if($errors->has('type'))
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" class="form-control" aria-describedby="nameHelp" placeholder="Enter Discount" name="discount" value="{{$promotion->discount}}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea id="description" name="description" rows="4" cols="50" maxlength="200" class="form-control" placeholder="Write here....">{{$promotion->description}}
                                        </textarea>
