                            ...
                            <form method="post" action="{{url('admin/store-category')}}">
                                    ...
                                    <div class="form-group col-md-8">
                                        <fieldset>
                                            <div class="form-group col-md-3">
                                                <input type="radio" name="category" id="event" value="0" checked>
                                                <label style="margin-left: 6px;" for="event">Add Category</label>
                                            </div>
                                            <div class="form-group col-md-3">
                                                <input type="radio" name="category" id="message" value="1">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6"  id="cat_name_div">
                                        ...
                                        <input type="text" class="form-control" aria-describedby="nameHelp" placeholder="Enter Category Name" name="category_name" value="{{old('category_name')}}">
                                    ...
                                    <div class="form-group col-md-6" id="sub_cat_div">
                                        ...
                                        <input type="text" class="form-control" aria-describedby="nameHelp" placeholder="Enter Sub-Category Name" name="sub_cat_name" value="{{old('sub_cat_name')}}">
